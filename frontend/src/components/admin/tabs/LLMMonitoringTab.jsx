...
// LLM metrics explanations
const llmKpis = [
    { term: 'Total Operations', description: 'Count of all AI/LLM API calls (completions, embeddings, parsing).' },
    { term: 'Total Tokens', description: 'Sum of all tokens processed (input + output). Affects API cost.' },
    { term: 'Input Tokens', description: 'Tokens sent to the model (prompts, context, documents).' },
    { term: 'Output Tokens', description: 'Tokens generated by the model (responses, completions).' },
    { term: 'Avg Latency', description: 'Average time for LLM requests to complete. Higher = slower.' },
    { term: 'Error Rate', description: 'Percentage of failed LLM calls (timeouts, rate limits, errors).' },
    { term: 'Model', description: 'Specific AI model used (gpt-4, gpt-3.5-turbo, text-embedding-ada, etc.).' }
]
...
const LLMMonitoringTab = ({ llmMetrics, llmCompanyFilter, setLlmCompanyFilter, fetchLlmMetrics }) => {
    ...
    return (
        <div className="space-y-6">
            {/* Help Section */}
            <TabHelpSection
                title="Understanding LLM Metrics"
                storageKey="llm"
                items={llmKpis}
            />
            {/* Header */}
